        ...
        {addedPhotos.length > 0 &&
          addedPhotos.map((link) => (
            ...
            <div className="relative flex h-32" key={link}>
              ...
              {/* Button for deleting the photo */}
              <button
                onClick={(ev) => removePhoto(ev, link)}
                className=" absolute bottom-2 right-1 cursor-pointer rounded-xl bg-white  px-2 py-1 "
              >
                <svg
              ...
              {/* Button for making the photo cover pic */}
              <button
                onClick={(ev) => selectAsMainPhoto(ev, link)}
                className=" absolute bottom-2 left-1 cursor-pointer rounded-xl bg-white  px-2 py-1 "
              >
                {link === addedPhotos[0] && (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
